...
1.) Open the Koha Circulation module and select "Holds queue"<br />&nbsp;<br />
2.) Leave the collection dropdown set as "All" and click "Submit"<br />&nbsp;<br />
4.) Leave all default columns visible. Click "Export" and select "Excel"<br />&nbsp;<br />
6.) Click the "Browse..." or "Choose File" button on the page, locate the exported spreadsheet in the file explorer window that opens, and then press the "Process Spreadsheet" button<br />&nbsp;<br />
...
4.) Checks for videogame item type and deletes all text after a ] (The videogame console is identified by brackets [Switch], [PS5], etc. so using that to clean up the remaining text in the title column).
